...
const Details = ({ feedback }: { feedback: Feedback | undefined }) => {
  if (!feedback) {
    return (
      <div className="bg-white rounded-2xl shadow-md w-full p-8 text-center">
        <p className="text-gray-500">Details will appear here once the analysis is complete.</p>
      </div>
    );
  }
  ...
  return (
      <div className="flex flex-col gap-4 w-full">
        <Accordion>
          ...
          {feedback.structure?.score !== undefined && (
